...
class DPIEP(MassProfile):
    ...
    _name = "dPIE"
    _params = ['E0', 'Ra', 'Rs', 'center_x', 'center_y', 'e1', 'e2']
    ...
    @tf.function
    def deriv(self, x, y, E0, Ra, Rs, e1, e2, center_x=0, center_y=0):
        ...
        fx, fy = self.spherical.deriv(x, y, E0, Ra, Rs, center_x=0, center_y=0)
        fx *= tf.math.sqrt(1 - e)
        fy *= tf.math.sqrt(1 + e)
